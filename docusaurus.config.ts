...
const config: Config = {
  ...
  url: 'https://www.courseasaurus.com',
  ...
  projectName: 'courseasaurus', // Usually your repo name.
  ...
  plugins: [
    [path.resolve(__dirname, './plugins/courseasaurus/index.ts'), {
    ...
    [
      '@docusaurus/plugin-content-docs',
      {
        ...
        routeBasePath: 'instructor-manual',
  ...
  themeConfig: {
    ...
    navbar: {
      title: 'Courseasaurus',
      logo: {
        alt: 'Courseasaurus Logo',
        src: 'img/logo.svg',
      },
      items: [
        {
          type: 'docSidebar',
          sidebarId: 'instructorManualSidebar',
          docsPluginId: 'instructor-manual',
          position: 'left',
          label: 'Instructor Manual',
        },
        {
          to: '/syllabus',
          position: 'left',
