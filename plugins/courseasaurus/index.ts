...
import fs from 'fs';
import type { CourseasaurusPluginOptions, CourseConfig, CourseSchedule } from './types';
import { validateCourseConfig } from './config-validator';
import { generateSchedule } from './schedule-generator';
import { extractHeadings, formatDateDisplay } from './utils';

export default async function pluginCourseasaurus(
    context: LoadContext,
    options: CourseasaurusPluginOptions
): Promise<Plugin<CourseSchedule | null>> {
    console.log("🦕 Courseasaurus plugin loaded");
...
# ${config.courseCode}: ${config.courseTitle}\n\n`;
    ...
    return {
        name: 'docusaurus-plugin-courseasaurus',
...
export type { CourseasaurusPluginOptions, CourseConfig, CourseSchedule } from './types';
// Export utilities
export * from './utils';
